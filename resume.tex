...
\begin{projects}
  ...
  { \keyword{Docker} \keyword{Java 21 (Spring Boot)} \keyword{Go} \keyword{Redis} \keyword{PostreSQL} \keyword{Kafka}  \keyword{NiFi} }
...
\item \project{INFORTANT}{Reporting system for tracking TRx capacity changes of a telecom operator enabling monthly difference reports to government telecom authorities.}{  \keyword{Java} \keyword{Java 21 (Spring Boot)} \keyword{Oracle} \keyword{React}  }
...
\begin{achievements}
  \item CASP Undergraduate Scholarship
  \item European Union Educational Scholarship
