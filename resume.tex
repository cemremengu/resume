...
\item \project{INFORTANT}{Reporting system for tracking TRx capacity changes of a telecom operator enabling monthly difference reports to government telecom authorities}{  \keyword{Java} \keyword{Spring Boot} \keyword{Oracle} \keyword{React}  }
